...
void GMainWindow::BootGame(const QString& filename, u64 program_id, std::size_t program_index,
    ...
    if (program_id > static_cast<u64>(Service::AM::Applets::AppletTitleId::MaxTitleId)) {
...
void GMainWindow::OnAlbum() {
    constexpr u64 AlbumId = static_cast<u64>(Service::AM::Applets::AppletTitleId::PhotoViewer);
...
void GMainWindow::OnCabinet(Service::NFP::CabinetMode mode) {
    constexpr u64 CabinetId = static_cast<u64>(Service::AM::Applets::AppletTitleId::Cabinet);
    auto bis_system = system->GetFileSystemController().GetSystemNANDContents();
    if (!bis_system) {
        QMessageBox::warning(this, tr("No firmware available"),
...
void GMainWindow::OnMiiEdit() {
    constexpr u64 MiiEditId = static_cast<u64>(Service::AM::Applets::AppletTitleId::MiiEdit);
    auto bis_system = system->GetFileSystemController().GetSystemNANDContents();
    if (!bis_system) {
        QMessageBox::warning(this, tr("No firmware available"),
